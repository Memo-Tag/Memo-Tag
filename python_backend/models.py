...
class UserLoginHistory(Base):
    """User login history table - tracks all user login/signup events"""
    ...
    email = Column(String(320), nullable=True)
    name = Column(Text, nullable=True)
    login_method = Column('loginMethod', String(64), nullable=False)
    ...
    __table_args__ = (
        Index('userLoginHistory_userId_idx', 'userId'),
    )
